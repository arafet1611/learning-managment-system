          ...
          <div className="col-lg-4">
            <div className="contact row mb-4">
              ...
              <ul className="contact-info list-unstyled col-lg-9 col-9  light-300">
                <li className="h5 mb-0">Alamni</li>
                <li className="text-muted">Alamni@address.com</li>
                <li className="text-muted">+216 50 132 080 </li>
              </ul>
            </div>
            <div className="contact row mb-4">
              <div className="contact-icon col-lg-3 col-3">
              ...
              <ul className="contact-info list-unstyled col-lg-9 col-9 light-300">
                <li className="h5 mb-0">Arafet Alaya</li>
                <li className="text-muted">arafetalaya6@gmail.com</li>
                <li className="text-muted">+216 50 132 080</li>
              </ul>
            </div>
            <div className="contact row mb-4">
              ...
              <ul className="contact-info list-unstyled col-lg-9 col-9 light-300">
                ...
                <li className="text-muted">Mahdia</li>
                <li className="text-muted">Tunisia</li>
              </ul>
            </div>
          </div>
          <div className="col-lg-8 ">
            <form className="contact_form row" method="post" action="#">
              ...
              <div className="col-md-12 col-12 m-auto text-end">
                <button
                  type="submit"
                  className="btn btn-info rounded-pill px-md-5 px-4 py-2 radius-0 text-light light-300"
                >
                  Send Message
                </button>
              </div>
